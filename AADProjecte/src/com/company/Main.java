...
public class Main {
    ...
    private static ArrayList<Peticion> validatedPeticiones;


    public static void main(String[] args) {
        validatedPeticiones = new ArrayList<>();
        readConfig();
        ArrayList<String> peticiones = readPeticiones();
        if (peticiones != null) {
            validatePeticones(peticiones);
        }
        validatedPeticiones.forEach(System.out::println);
    }
